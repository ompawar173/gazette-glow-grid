...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CIO Media World — Enterprise Technology News" },
      ...
      { name: "theme-color", content: "#007DB7" },
      { name: "format-detection", content: "telephone=no" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "CIO Media World — Enterprise Technology News" },
      { name: "twitter:title", content: "CIO Media World — Enterprise Technology News" },
