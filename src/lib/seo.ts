export const SITE_URL = "https://ciomediaworld.com";
export const SITE_NAME = "CIO Media World";
export const SITE_TAGLINE = "The Voice of Enterprise Technology";
export const PUBLISHER_LOGO = `${SITE_URL}/cio-media-world-logo.png`;
export const EDITORIAL_EMAIL = "editorial@ciotimes.com";
export const SALES_EMAIL = "sales@ciotimes.com";
...
export const organizationSchema = {
  ...
  description: `${SITE_NAME} is an enterprise technology publication covering AI, cloud, cybersecurity, and IT leadership for enterprise executives.`,
